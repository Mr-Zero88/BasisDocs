...
When you [open a bug report](https://github.com/BasisVR/Basis/issues/new/choose), the form asks for your **Build Info**. Inside Basis, open **Settings → Developer** and click **Copy Build Info** — this copies your version, Unity version, platform, mode, and build GUID to the clipboard, ready to paste into the report.

<Callout type="info">
If the **Build & Environment** section isn't visible on the Developer tab, turn it on under the **Section Visibility** toggles near the top of that tab.
</Callout>
